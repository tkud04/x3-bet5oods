...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(url('/')); ?>">
                ...
                <div class="sidebar-brand-text mx-3">Gmail Sender <sup>x3</sup></div>
            </a>
                ...
                <div style="margin-top: 5px;">
                  ...
                  <br>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                           <button id="authorize_button" onclick="handleAuthClick()" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                              <i class="fas fa-user fa-sm text-white-50"></i> Authorize
                           </button>
                           <button id="signout_button" onclick="handleSignoutClick()" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">
                              <i class="fas fa-key fa-sm text-white-50"></i> Sign out
                           </button>
                        </div>
                    </div>
    ...
    <div class="col-md-12 mt-2 mb-5">
         <div class="form-group">
           <center> <button id="send-btn" class="btn btn-lg btn-primary">Send</button> </center>
         </div>
    </div>
                                    </div>
                                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Anonymous <?php echo e(date("Y")); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
</html><?php /**PATH /Users/mac/repos/x3-bet5oods/resources/views/index.blade.php ENDPATH**/ ?>